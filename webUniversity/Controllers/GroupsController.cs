...
namespace webUniversity.Controllers
{
    public class GroupsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("groupID,code,name")] Group @group)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("groupID,code,name")] Group @group)
        {
            if (id != @group.groupID)
            {
                return NotFound();
